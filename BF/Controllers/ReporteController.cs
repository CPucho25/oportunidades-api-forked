...
namespace BF.Controllers
{
    ...
    public class ReporteController : ControllerBase
    {
        ...
        public RespondSearchObject<List<VWListarSocxServ>> buscarServicio(DTOOportunidad dto)
        {
            try
            {
                ...
                switch (dto.IdRol)
                {
                    //Adminitrador
                    case 1:
                        listSocServ = _context.VWListarSocxServ.Where(item => (dto.IdPeriodo == 0 ? item.IdPeriodo == 3 : item.IdPeriodo == dto.IdPeriodo)
                                                                            && item.FlgActivo == 1
                                                                        )
                    ...
                    case 2:
                        listSocServ = _context.VWListarSocxServ.Where(item => item.IdSocio == dto.IdSocio
                                                                            && (dto.IdPeriodo == 0 ? item.IdPeriodo == 3 : item.IdPeriodo == dto.IdPeriodo)
                                                                            && item.FlgActivo == 1
                                                            )
                        .Select(item => new VWListarSocxServ
                        {
                ...
                {   //euscuvil 13-10-2022
                    ...
                    case 1:
                        if (area == 1)
                        {
                            ...
                            worksheet.Cells[1, 15].Value = "Overrun";
                            ...
                            dto.ForEach(data =>
                            {
                                ...
                                worksheet.Cells[row, 15].Value = data.Overrun;
                    ...
                    case 2:
                        if (area == 1)
                        {
                            ...
                            worksheet.Cells[1, 14].Value = "Overrun";
                            ...
                            dto.ForEach(data =>
                            {
                                ...
                                worksheet.Cells[row, 14].Value = data.Overrun;
                                worksheet.Cells[row, 14].Style.Numberformat.Format = "_(* #,##0.00_);_(* (#,##0.00);_(* \" - \"??_);_(@_)";
                    ...
                    case 6:
                        if (area == 1)
                        {
                            ...
                            dto.ForEach(data =>
                            {
                                ...
                                worksheet.Cells[row, 38].Value = data.Comentarios;
                                row++;
                            });
                            #endregion
                        }
        ...
        public MemoryStream FormatoReporteFacturacion(List<VWListarFacturacionTotal> dto, Int32 rol)
        {
            MemoryStream memStream;
        ...
        public async Task<String> generarReporteMantFacturacion(DTOMantPrograFacturacion dto)
        {
            try
            {
                ...
                //Creamos reporte
                //Obtenemos los registros de la BD
                var listReporte = new List<VWListarFacturacionTotal>();
                listReporte = await _context.VWListarFacturacionTotal.Where(o =>
                                                                                  (dto.IdSocio == 0 ? 1 == 1 : o.IdSocio == dto.IdSocio)
                                                                                   && (dto.RazonSocial == "" || dto.RazonSocial == "0" || dto.RazonSocial == null
                                                                                       ? 1 == 1 :
        ...
        public async Task<String> generarReporteFacturacion(DTOMantPrograFacturacion dto)
        {
            try
            {
                ...
                listReporte = await _context.VWListarReporteFacturacion.Where(o => o.FlgActivo == 1
